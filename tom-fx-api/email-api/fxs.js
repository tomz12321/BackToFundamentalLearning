...
const fromEmail = process.env.EMAIL_FXS
const toEmail = process.env.RECIPIENT_FXS
const itsEmail = process.env.ITS_FXS
...
function generate_email_content(form_name, message_content) {
  ...
  <hr>
  <p>
      A submission has been made on the www.forexsport.com website.
  </p>
  <p>
